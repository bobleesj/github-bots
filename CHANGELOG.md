...
- `_pr-large-files.yml`: warn when a PR adds files over about 1 MB, or notebooks over about 500 KB. Comment links `docs/large-files.md` for Hugging Face upload, `save_state=False`, and `quantem github`.
